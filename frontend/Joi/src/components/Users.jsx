...
function Users() {
  ...
  useEffect(() => {
    axios.get("https://brain-snap-server.vercel.app/main", { headers: { Authorization: `Bearer ${Cookies.get('Token')}` } })
      .then(result => {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://brain-snap-server.vercel.app/main/deleteUser/${id}`)
      .then(res => {
        console.log(res);
