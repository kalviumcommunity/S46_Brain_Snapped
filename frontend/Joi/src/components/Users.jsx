...
function Users() {
  ...
  useEffect(() => {
    axios.get("https://backend-part2-ymp1.vercel.app/main", { headers: { Authorization: `Bearer ${Cookies.get('Token')}` } })
      .then(result => {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://backend-part2-ymp1.vercel.app/main/deleteUser/${id}`)
      .then(res => {
        console.log(res);
